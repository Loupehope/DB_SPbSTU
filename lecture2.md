...
Monitoring RMAN:
- V$SESSION V$PROCESS - утсановить связь между сессиями и каналами RMAN
...
- V$SESSION_LONGOPS - определяет статус операций с временем более 9с
...
- Предохранять RMAN от большой пропускной способности
- Уровень мультиплекирования
- Сконфигурировать несколько дисков
...
- MAXOPENFILES - не считывалось много файлов за раз
