...
- Установка параметров шифрования и компрессии (COMPRESSED - только backup set - удаление пустых экстентов)
...
- Можно переписать с опцией FORCE
